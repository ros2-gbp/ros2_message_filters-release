## message_filters (rolling) - 8.0.4-1

The packages in the `message_filters` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling message_filters` on `Thu, 10 Sep 2026 12:05:22 -0000`
...
## message_filters (humble) - 4.3.20-1

The packages in the `message_filters` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble message_filters` on `Mon, 07 Sep 2026 18:05:43 -0000`
...
- upstream repository: https://github.com/ros2/message_filters.git
- release repository: https://github.com/ros2-gbp/ros2_message_filters-release.git
- rosdistro version: `4.3.19-1`
- old version: `4.3.19-1`
- new version: `4.3.20-1`
...
## message_filters (rolling) - 8.0.3-1

The packages in the `message_filters` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling message_filters` on `Wed, 02 Sep 2026 08:50:32 -0000`
...
## message_filters (lyrical) - 7.4.2-1

The packages in the `message_filters` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical --track lyrical message_filters` on `Mon, 29 Jun 2026 14:48:56 -0000`
...
## message_filters (rolling) - 8.0.2-1

The packages in the `message_filters` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling message_filters` on `Mon, 29 Jun 2026 14:47:25 -0000`
...
## message_filters (jazzy) - 4.11.17-1

The packages in the `message_filters` repository were released into the `jazzy` distro by running `/home/marcogg/.local/bin/bloom-release --track jazzy --rosdistro jazzy message_filters` on `Sun, 14 Jun 2026 04:47:17 -0000`
...
- upstream repository: https://github.com/ros2/message_filters.git
- release repository: https://github.com/ros2-gbp/ros2_message_filters-release.git
- rosdistro version: `4.11.16-1`
- old version: `4.11.16-1`
- new version: `4.11.17-1`
...
## message_filters (jazzy) - 4.11.16-1

The packages in the `message_filters` repository were released into the `jazzy` distro by running `/home/marcogg/.local/bin/bloom-release --track jazzy --rosdistro jazzy message_filters` on `Tue, 09 Jun 2026 03:03:55 -0000`
...
- upstream repository: https://github.com/ros2/message_filters.git
- release repository: https://github.com/ros2-gbp/ros2_message_filters-release.git
- rosdistro version: `4.11.15-1`
- old version: `4.11.15-1`
- new version: `4.11.16-1`
...
## message_filters (humble) - 4.3.18-1

The packages in the `message_filters` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble message_filters` on `Mon, 25 May 2026 13:10:47 -0000`
...
- upstream repository: https://github.com/ros2/message_filters.git
- release repository: https://github.com/ros2-gbp/ros2_message_filters-release.git
- rosdistro version: `4.3.16-1`
- old version: `4.3.17-1`
- new version: `4.3.18-1`
...
## message_filters (jazzy) - 4.11.15-1

The packages in the `message_filters` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy message_filters` on `Fri, 22 May 2026 09:39:43 -0000`
...
- upstream repository: https://github.com/ros2/message_filters.git
- release repository: https://github.com/ros2-gbp/ros2_message_filters-release.git
- rosdistro version: `4.11.13-1`
- old version: `4.11.14-1`
- new version: `4.11.15-1`
...
## message_filters (kilted) - 7.1.10-1

The packages in the `message_filters` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted message_filters` on `Fri, 22 May 2026 09:37:08 -0000`
...
## message_filters (humble) - 4.3.17-1

The packages in the `message_filters` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble message_filters` on `Wed, 20 May 2026 20:12:54 -0000`
...
- release repository: https://github.com/ros2-gbp/ros2_message_filters-release.git
- rosdistro version: `4.3.16-1`
- old version: `4.3.16-1`
- new version: `4.3.17-1`
...
## message_filters (jazzy) - 4.11.14-1

The packages in the `message_filters` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy message_filters` on `Wed, 20 May 2026 19:57:16 -0000`
...
- release repository: https://github.com/ros2-gbp/ros2_message_filters-release.git
- rosdistro version: `4.11.13-1`
- old version: `4.11.13-1`
- new version: `4.11.14-1`
...
## message_filters (kilted) - 7.1.9-1

The packages in the `message_filters` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted message_filters` on `Wed, 20 May 2026 19:54:09 -0000`
...
## message_filters (lyrical) - 7.4.1-1

The packages in the `message_filters` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical --track lyrical message_filters` on `Tue, 12 May 2026 22:04:05 -0000`
...
## message_filters (rolling) - 8.0.1-1

The packages in the `message_filters` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling message_filters` on `Tue, 12 May 2026 22:01:10 -0000`
...
## message_filters (lyrical) - 7.4.0-1

The packages in the `message_filters` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical --track lyrical message_filters` on `Wed, 06 May 2026 19:48:32 -0000`
...
## message_filters (rolling) - 8.0.0-1

The packages in the `message_filters` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling message_filters` on `Wed, 06 May 2026 09:18:29 -0000`
...
- upstream repository: https://github.com/ros2/message_filters.git
- release repository: https://github.com/ros2-gbp/ros2_message_filters-release.git
- rosdistro version: `4.3.15-1`
- old version: `4.3.15-1`
- new version: `4.3.16-1`
...
## message_filters (jazzy) - 4.11.13-1

The packages in the `message_filters` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy message_filters` on `Thu, 09 Apr 2026 14:15:43 -0000`
...
- upstream repository: https://github.com/ros2/message_filters.git
- release repository: https://github.com/ros2-gbp/ros2_message_filters-release.git
- rosdistro version: `4.11.12-1`
- old version: `4.11.12-1`
- new version: `4.11.13-1`
...
## message_filters (kilted) - 7.1.8-1

The packages in the `message_filters` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted message_filters` on `Thu, 09 Apr 2026 14:04:08 -0000`
...
## message_filters (rolling) - 7.3.8-1

The packages in the `message_filters` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling message_filters` on `Thu, 09 Apr 2026 13:40:03 -0000`
...
## message_filters (humble) - 4.3.15-1

The packages in the `message_filters` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble message_filters` on `Tue, 24 Mar 2026 21:46:24 -0000`
...
- upstream repository: https://github.com/ros2/message_filters.git
- release repository: https://github.com/ros2-gbp/ros2_message_filters-release.git
- rosdistro version: `4.3.14-1`
- old version: `4.3.14-1`
- new version: `4.3.15-1`
...
## message_filters (jazzy) - 4.11.12-1

The packages in the `message_filters` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy message_filters` on `Tue, 24 Mar 2026 21:32:00 -0000`
...
- upstream repository: https://github.com/ros2/message_filters.git
- release repository: https://github.com/ros2-gbp/ros2_message_filters-release.git
- rosdistro version: `4.11.11-1`
- old version: `4.11.11-1`
- new version: `4.11.12-1`
...
## message_filters (kilted) - 7.1.7-1

The packages in the `message_filters` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted message_filters` on `Tue, 24 Mar 2026 21:25:34 -0000`
...
## message_filters (rolling) - 7.3.7-1

The packages in the `message_filters` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling message_filters` on `Tue, 24 Mar 2026 16:22:47 -0000`
...
## message_filters (humble) - 4.3.14-1

The packages in the `message_filters` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble message_filters` on `Thu, 19 Feb 2026 02:03:37 -0000`
...
- upstream repository: https://github.com/ros2/message_filters.git
- release repository: https://github.com/ros2-gbp/ros2_message_filters-release.git
- rosdistro version: `4.3.13-1`
- old version: `4.3.13-1`
- new version: `4.3.14-1`
...
## message_filters (humble) - 4.3.13-1

The packages in the `message_filters` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble message_filters` on `Wed, 04 Feb 2026 16:36:33 -0000`
...
- upstream repository: https://github.com/ros2/message_filters.git
- release repository: https://github.com/ros2-gbp/ros2_message_filters-release.git
- rosdistro version: `4.3.12-1`
- old version: `4.3.12-1`
- new version: `4.3.13-1`
...
## message_filters (jazzy) - 4.11.11-1

The packages in the `message_filters` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy message_filters` on `Wed, 04 Feb 2026 16:30:17 -0000`
...
- upstream repository: https://github.com/ros2/message_filters.git
- release repository: https://github.com/ros2-gbp/ros2_message_filters-release.git
- rosdistro version: `4.11.10-1`
- old version: `4.11.10-1`
- new version: `4.11.11-1`
...
## message_filters (kilted) - 7.1.6-1

The packages in the `message_filters` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted message_filters` on `Wed, 04 Feb 2026 16:24:16 -0000`
...
## message_filters (rolling) - 7.3.6-1

The packages in the `message_filters` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling message_filters` on `Wed, 04 Feb 2026 16:14:48 -0000`
...
## message_filters (humble) - 4.3.12-1

The packages in the `message_filters` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble message_filters` on `Thu, 15 Jan 2026 10:45:21 -0000`
...
- upstream repository: https://github.com/ros2/message_filters.git
- release repository: https://github.com/ros2-gbp/ros2_message_filters-release.git
- rosdistro version: `4.3.11-1`
- old version: `4.3.11-1`
- new version: `4.3.12-1`
...
## message_filters (jazzy) - 4.11.10-1

The packages in the `message_filters` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy message_filters` on `Thu, 15 Jan 2026 10:40:32 -0000`
...
- upstream repository: https://github.com/ros2/message_filters.git
- release repository: https://github.com/ros2-gbp/ros2_message_filters-release.git
- rosdistro version: `4.11.9-1`
- old version: `4.11.9-1`
- new version: `4.11.10-1`
...
## message_filters (kilted) - 7.1.5-1

The packages in the `message_filters` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted message_filters` on `Thu, 15 Jan 2026 10:28:34 -0000`
...
## message_filters (rolling) - 7.3.5-1

The packages in the `message_filters` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling message_filters` on `Thu, 15 Jan 2026 10:23:40 -0000`
...
## message_filters (rolling) - 7.3.4-1

The packages in the `message_filters` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling message_filters` on `Wed, 12 Nov 2025 15:50:59 -0000`
...
## message_filters (humble) - 4.3.11-1

The packages in the `message_filters` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble message_filters` on `Wed, 15 Oct 2025 16:11:39 -0000`
...
- upstream repository: https://github.com/ros2/message_filters.git
- release repository: https://github.com/ros2-gbp/ros2_message_filters-release.git
- rosdistro version: `4.3.10-1`
- old version: `4.3.10-1`
- new version: `4.3.11-1`
...
## message_filters (jazzy) - 4.11.9-1

The packages in the `message_filters` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy message_filters` on `Wed, 15 Oct 2025 15:40:37 -0000`
...
- upstream repository: https://github.com/ros2/message_filters.git
- release repository: https://github.com/ros2-gbp/ros2_message_filters-release.git
- rosdistro version: `4.11.8-1`
- old version: `4.11.8-1`
- new version: `4.11.9-1`
...
## message_filters (kilted) - 7.1.4-1

The packages in the `message_filters` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted message_filters` on `Wed, 15 Oct 2025 15:36:30 -0000`
...
## message_filters (rolling) - 7.3.3-1

The packages in the `message_filters` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling message_filters` on `Wed, 15 Oct 2025 15:32:26 -0000`
...
## message_filters (humble) - 4.3.10-1

The packages in the `message_filters` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble message_filters` on `Fri, 03 Oct 2025 13:44:02 -0000`
...
- upstream repository: https://github.com/ros2/message_filters.git
- release repository: https://github.com/ros2-gbp/ros2_message_filters-release.git
- rosdistro version: `4.3.9-1`
- old version: `4.3.9-1`
- new version: `4.3.10-1`
...
## message_filters (jazzy) - 4.11.8-1

The packages in the `message_filters` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy message_filters` on `Fri, 03 Oct 2025 13:39:05 -0000`
...
- upstream repository: https://github.com/ros2/message_filters.git
- release repository: https://github.com/ros2-gbp/ros2_message_filters-release.git
- rosdistro version: `4.11.7-1`
- old version: `4.11.7-1`
...
## message_filters (kilted) - 7.1.3-1

The packages in the `message_filters` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted message_filters` on `Fri, 03 Oct 2025 13:35:06 -0000`
...
## message_filters (rolling) - 7.3.2-1

The packages in the `message_filters` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling message_filters` on `Fri, 03 Oct 2025 13:30:27 -0000`
...
## message_filters (humble) - 4.3.9-1

The packages in the `message_filters` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble message_filters` on `Wed, 17 Sep 2025 12:44:46 -0000`
...
## message_filters (kilted) - 7.1.2-1

The packages in the `message_filters` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted message_filters` on `Wed, 17 Sep 2025 12:38:05 -0000`
...
## message_filters (rolling) - 7.3.1-1

The packages in the `message_filters` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling message_filters` on `Wed, 17 Sep 2025 12:33:42 -0000`
...
## message_filters (jazzy) - 4.11.7-1

The packages in the `message_filters` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy message_filters` on `Wed, 06 Aug 2025 13:49:29 -0000`
...
- old version: `4.11.6-2`
- new version: `4.11.7-1`
...
## message_filters (rolling) - 7.3.0-1

The packages in the `message_filters` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling message_filters` on `Tue, 29 Jul 2025 21:14:42 -0000`
...
## message_filters (humble) - 4.3.8-1

The packages in the `message_filters` repository were released into the `humble` distro by running `/usr/bin/bloom-release --track humble --rosdistro humble message_filters` on `Wed, 16 Jul 2025 18:23:12 -0000`
...
## message_filters (rolling) - 7.2.2-1
